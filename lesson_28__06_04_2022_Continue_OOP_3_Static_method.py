...
print("Пример 2 Урока 28 06.04.2022: Создать Класс, Открытие Счета\n"
      ...
      "7) Сменить Владельца.\n"
      "8) Закрыть Счет.")
print("Сздать Класс Account, Представляющий собой Банковский Счет. Класс должен Содержать:\n"
      "1) Динамические Свойства: Фамилию Владельца, Номер Счета, Процент Начисления,\n"
      "\tсумма в рублях;\n"
      "2) Статические Свойства: Курс Рубля по отношению к Доллару,\n"
      "\tСтатические Свойства: Курс Рубля по отношению к Евро"
      "3) Классовые Методы: Редактировать Курс Рубля по отношению к Доллару,\n"
      "\tРедактировать Курс Рубля по отношению к Евро;\n"
      "4) Статические Методы: Перевод Суммы в Доллары и Евро.\n"
      "5) Инициализатор: Определяет Динамические Свойства Класса и\n"
      "\tВыводит Информацию Об Открытом Счете.\n"
      "6) Деструктор: Выводит Сообщение о том, что Банковский Счет Закрыт.\n"
      "7) Методы: Смена Владельца Счета, Снятие Заданной Суммы,\n"
